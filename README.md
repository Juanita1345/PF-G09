...
| **Fórmula**                                                                                      | $KPI = \frac{\sum_{Trimestre_{actual}} (LlegadaProgramada-LlegadaReal) - \sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal)} {\sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal)}$ |
