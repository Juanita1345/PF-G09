...
|--------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Requerimiento de Datos**                                                                       | Tiempo de llegada Programado vuelo, Tiempo de llegada Real vuelo.                                                                                                            |
| **Fórmula**                                                                                      | $KPI = 100*\frac{\sum_{Trimestre_{actual}} (LlegadaProgramada-LlegadaReal) - \sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal)} {\sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal)}$ |

| **Valor del KPI: REDUCIR RETRASOS EN ARRIBO DE VUELOS EN UN 5% TRIMESTRALMENTE, POR AEROPUERTO** | Este KPI es un indicador que determina el porcentaje de  variación trimestral de la sumatoria de los retrasos en minutos de cada aeropuerto,  del estado de Georgia, respecto del mismo trimestre del año anterior. |
|--------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Requerimiento de Datos**                                                                       | Tiempo de llegada Programado vuelo, Tiempo de llegada Real vuelo.                                                                                                                                                   |
| **Fórmula**                                                                                      | $KPI = 100*\sum_{Trimestre_{actual}} (LlegadaProgramada-LlegadaReal) - \sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal) \sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal)$                           |

| **Valor del KPI: DISMINUIR NÚMERO DE CANCELACIONES DE VUELOS EN UN 5% TRIMESTRALMENTE, POR AEROLÍNEA** | Este KPI es un indicador que determina el porcentaje de  variación trimestral de la sumatoria de cancelaciones de vuelos de cada aerolínea, respecto del mismo trimestre del año anterior |
|--------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Requerimiento de Datos**                                                                             | Tiempo de llegada Programado vuelo, Tiempo de llegada Real vuelo.                                                                                                                         |
| **Fórmula**                                                                                            | $KPI = 100*\sum_{Trimestre_{actual}} (LlegadaProgramada-LlegadaReal) - \sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal) \sum_{Trimeste_{anterior}} (LlegadaProgramada-LlegadaReal)$ |

| **Valor del KPI: AUMENTAR CANTIDAD DE PASAJEROS DE VUELOS EN UN 2% MENSUALMENTE, POR AEROLÍNEA** | Este KPI es un indicador que determina el porcentaje de  variación mensual de la sumatoria de los pasajeros de los vuelos de cada aerolínea, respecto del mes anterior |
|--------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Requerimiento de Datos**                                                                       | Número de pasajeros mensuales por aerolínea                                                                                                                            |
| **Fórmula**                                                                                      | $KPI = \sum_{Mes_{actual}} (Pasajeros) - \sum_{Mes_{anterior}} (Pasajeros) \sum_{Mes_{anterior}} (Pasajeros)$                                                          |
...
| **Requerimiento de Datos**              | Tiempo de retraso de salida y tiempo de retraso de llegada.                                                                                                                                                        |
| **Fórmula**                             | $KPI = \mu(Retraso_{salida}-Retraso_{llegada})$                                                                                                                                                                    |
