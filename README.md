...
|-----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| **Objetivo**                            | Identificar si el vuelo llega con un tiempo efectivo o con un retraso general.                                                                                                                                     | Entender con mayor facilidad la eficiencia de tiempo de un vuelo. Caracterizar la eficiencia del vuelo con respecto al tiempo de vuelo total. |
